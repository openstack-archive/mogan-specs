...
in mogan, and mogan will handle the aggregate traits.
...
aggregate traits, then got a list of aggregates, and pass it to placement with
`member_of` parameter when listing resource providers::
