...
#. Mogan will get the image and resource class from manageable node and
   will check if the flavor in Mogan matches the resource class in node.
   After getting those information, Mogan will set them to server resource.
